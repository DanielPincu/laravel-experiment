        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 space-y-4">
                    ...
                    <form action="{{ route('products.store') }}" method="POST" class="mt-6 w-full max-w-2xl mx-auto bg-gray-50 dark:bg-gray-900 shadow-md rounded-lg p-8 space-y-5">
                        @csrf
                        ...
                        <div>
                            ...
                            <textarea name="details" id="details" rows="4"
                                      class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400">{{ old('details') }}</textarea>
                        </div>
